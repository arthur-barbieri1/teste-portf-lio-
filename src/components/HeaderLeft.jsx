...
import { BiBriefcase, BiCodeAlt, BiHome, BiMailSend, BiRightArrowAlt } from 'react-icons/bi'
    ...
    <div className='md:flex-[1]'> 
        ...
        <div className='min-h-screen top-0 hidden md:sticky md:flex items-center justify-center bg-teal-600 text-white'>
            <ul className='flex flex-col gap-10'>
                ...
                .map((item) => (
                    <li key={item} className='flex items-center juitify-start cursor-pointer font-medium 
                    transition-all duration-200 group sm:text-lg md:text-xl xl:text-3x1'>
                        <BiRightArrowAlt className='text-4xl-translate-x-5 opacity-0 transform transition-all 
