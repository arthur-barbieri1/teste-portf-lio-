  ...
  return (
    <div id='project' className='min-h-screen w-full flex flex-col items-center justrify-center gap-20 p-10 md:p-16 xl:px-32'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5'>
        ...
        <div className='text-left space-y-2 border-2 hover:scale-105 transition-all duration-200 cursor-pointer px-8 py-10 vorder-teal-500 rounded-lg hover:bg-teal-50'>
